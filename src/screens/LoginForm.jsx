...
//   style = {},
// }) {
//   const { language: lang } = useContext(LanguageContext); // use global context
...
import LanguageToggle from "../components/LanguageToggle";
import { LanguageContext } from "../components/LanguageContext"; // ✅ correct path
...
export default function LoginForm({
  ...
  const { language: lang } = useContext(LanguageContext); // ✅ use global language
