...
//   'annual_turnover',
//   'profit_percentage',
//   'loan_details', // IMPORTANT: include this
...
// // parse backend format {amount=40000, institution=NBFC, ...} into a JS object
// function parseLoanDetails(raw) {
//   if (!raw) return null;
...
//   // Try JSON first: {"amount":40000,"institution":"NBFC"}
//   if (str.startsWith('{') && str.includes(':')) {
//     try {
//       const json = JSON.parse(str);
//       if (json && typeof json === 'object') return json;
//     } catch (e) {
//       // ignore JSON error and fallback to custom parsing
//     }
//   }

//   // Handle format like: {amount=40000, institution=NBFC, repayment=Ongoing}
//   const withoutBraces = str.replace(/^\{/, '').replace(/\}$/, '');
...
//     const value = rest.join('=').trim(); // join in case value itself has '='
//     if (key && value !== '') {
//       result[key] = value;
//     }
//   }
...
// // render a plain object as multiple key:value rows
// function renderObjectAsRows(obj, styles, keyPrefix = '') {
...
//         <Text style={styles.label}>{prettyKey}</Text>
//         <Text style={styles.value}>{String(value)}</Text>
//       </View>
//     );
//   });
...
//         );
//         if (Array.isArray(ex) && ex.length) {
//           setEnterprise({ ...ex[0], __sheet: 'ExistingEnterprise' });
//         } else {
//           // fallback to NewEnterprise
//           const nw = await gsApi.read(
//             'NewEnterprise',
//             'beneficiary_id',
//             beneficiary.id,
//             { cache: true }
//           );
//           if (Array.isArray(nw) && nw.length) {
//             setEnterprise({ ...nw[0], __sheet: 'NewEnterprise' });
//           } else {
//             setEnterprise(null);
//           }
//         }
...
//           {LABELS[language].beneficiaryHeader}
//         </Text>
//         {BENEFICIARY_FIELDS.map((k) => {
//           const raw = beneficiary[k];
//           const display =
//             k === 'dob' || k === 'shg_joining_date' ? fmtDate(raw) : raw;
//           return renderRow(k, display, styles);
//         })}
//       </View>
...
//       <View style={styles.card}>
//         <Text style={styles.sectionTitle}>
//           {LABELS[language].enterpriseDetails}
//         </Text>
...
//             <Text style={{ fontWeight: '700', marginBottom: 8 }}>
//               {enterprise.__sheet === 'ExistingEnterprise'
//                 ? LABELS[language].existingHeader
//                 : LABELS[language].newHeader}
//             </Text>
...
//                   // Loan details (special handling)
//                   if (key === 'loan_details') {
//                     const parsed = parseLoanDetails(raw);

//                     // If parsing fails, fallback to raw text once
//                     if (!parsed) {
//                       return renderRow(key, raw, styles);
//                     }
...
//                           {key.replace(/_/g, ' ')}
//                         </Text>
//                         {renderObjectAsRows(parsed, styles, 'loan_')}
//                       </View>
//                     );
//                   }
...
//                   if (!raw && raw !== 0) return null;
//                   if (
//                     ['created_at', 'updated_at', 'deleted_at'].includes(k) &&
//                     raw
//                   ) {
//                     return renderRow(k, fmtDate(raw), styles);
//                   }
...
//                   beneficiary,
//                   existingRecord: enterprise,
//                 })
//               }
//             >
//               <Text style={styles.buttonText}>
//                 {LABELS[language].editEnterprise}
//               </Text>
//             </TouchableOpacity>
//           </>
//         ) : (
...
//               {LABELS[language].noEnterprise}
//             </Text>
//             <TouchableOpacity
//               style={styles.button}
//               onPress={() =>
//                 navigation.navigate('EnterpriseForm', { beneficiary })
//               }
//             >
//               <Text style={styles.buttonText}>
//                 {LABELS[language].recordEnterprise}
//               </Text>
//             </TouchableOpacity>
//           </>
//         )}
